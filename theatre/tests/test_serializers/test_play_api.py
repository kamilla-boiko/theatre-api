...
class AdminPlayApiTests(TestCase):
    ...
    def test_create_play_with_genres(self):
        genre1 = Genre.objects.create(name="Ballet")
    ...
    def test_create_play_with_actors(self):
        actor1 = Actor.objects.create(first_name="Kate", last_name="Kuhar")
        actor2 = Actor.objects.create(first_name="Alex", last_name="Stoyanov")
        payload = {
            "title": "Romeo and Juliet",
